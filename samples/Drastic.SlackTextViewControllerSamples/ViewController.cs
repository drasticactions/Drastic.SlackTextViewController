using System;
using SlackHQ;
using SlackTextViewControllerSample;
using System.Text;
using UIKit;

namespace Drastic.SlackTextViewControllerSamples
{
    public class ViewController : SlackTextViewController
    {
        ...
        public void OnSimulateTyping(UIBarButtonItem sender)
        {
